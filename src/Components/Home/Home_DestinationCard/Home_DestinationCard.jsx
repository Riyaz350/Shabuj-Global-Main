  ...
  return (
    <div className="bg-color mt-20 pb-10 pt-[110px] lg:pb-[100px] relative">
      <div className="text-center">
        <h2 className="poppins-semibold lg:poppins-bold leading-[130%] -tracking-[0.02em] lg:text-[50px] text-[28px] text-gradient pb-2">
          Choose Your Destination
        </h2>
        <p className="poppins-bold lg:text-[67px] leading-[130%] tracking-tight text-[38px] text-white pb-[80px]">
          We’ll Plan the Rest
        </p>
      </div>
      ...
      <div className="relative lg:block hidden max-w-[1155px] mx-auto">
        <img
          src="./assets/planepath.png"
          className="absolute top-[-1350px] right-6"
          alt="path"
        />
      </div>
    </div>
