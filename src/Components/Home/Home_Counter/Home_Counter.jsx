    ...
    return (
        <div className="bg-gradient-two bg-[#EBEBEB] max-w-[1154px] mx-auto rounded-[64px] lg:mt-[200px]  lg:mb-[140px] mb-[28px] relative lg:z-20 mt-16">
            ...
            <div className="flex flex-col lg:block">
                <div className="lg:absolute lg:-top-44 lg:-z-40 order-2 pb-12 md:mx-auto lg:w-auto w-1/2 mx-auto">
                    <img src="https://i.ibb.co.com/rtSqMV2/strength1.png" alt="strength" className="w-full" />
                </div>
                
                <h2 className="poppins-bold text-gradient text-4xl text-center lg:text-[67px] py-20 lg:py-[101px] lg:text-right lg:pr-[66px] order-1">Our Core Strength</h2>
            </div>
            
            <ScrollTrigger onEnter={()=> setCounterState(true)} onExit={()=> setCounterState(false)}>
                <div className="flex justify-center flex-wrap gap-10 pb-[46px] pl-5 pr-5">
                    <div className="text-center child-one">
                        <img className="mx-auto" src="https://i.ibb.co.com/7R5rzV8/vector1.png" alt="icon" />
                    ...
                    <div className="text-center child-two">
                        <img className="mx-auto" src="https://i.ibb.co.com/6sZWGjp/vector2.png" alt="icon" />
                        <h2 className="poppins-bold pt-0 text-4xl lg:text-[50px] text-white mt-2">
                    ...
                    <div className="text-center child-three">
                        <img className="mx-auto" src="https://i.ibb.co.com/TmQyWkF/vector3.png" alt="icon" />
                        <h2 className="poppins-bold pt-0 text-4xl lg:text-[50px] text-white mt-2">
                    ...
                    <div className="text-center child-four">
                        <img className="mx-auto" src="https://i.ibb.co.com/rfHj5Cg/vector4.png" alt="icon" />
                        <h2 className="poppins-bold pt-0 text-4xl lg:text-[50px] text-white mt-2">
                    ...
                    <div className="text-center child-five">
                        <img className="mx-auto" src="https://i.ibb.co.com/fDX6C80/vector5.png" alt="icon" />
                        <h2 className="poppins-bold pt-0 text-4xl lg:text-[50px] text-white mt-2">
                    ...
                    <div className="text-center child-six">
                        <img className="mx-auto" src="https://i.ibb.co.com/Ld34nyH/vector6.png" alt="icon" />
                        <h2 className="poppins-bold pt-0 text-4xl lg:text-[50px] text-white mt-2">
            ...
            <div className="absolute -bottom-36 lg:block hidden">
                <img src="https://i.ibb.co.com/J7dN35r/bg-shape2.png" alt="" />
            </div>
        </div>
    );
};
