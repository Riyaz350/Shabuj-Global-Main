            ...
            <div className="tab-content tab-1 color_div text-center lg:text-left mb-[56px]">
                ...
                <div className='flex flex-col lg:flex-row justify-between gap-[28px]'>
                    <div className='order-2 lg:order-1'>
                        <h2 className='poppins-semibold text-[20px] lg:text-[38px] text-[#081831] leading-[130%] lg:text-left md:text-center text-left lg:px-0 px-6'>Get complete guidance in<br></br>
                            your study abroad journey-<br></br> from start to finish
                        </h2>
                        <p className='mulish-regular text-[12px] lg:text-[16px] text-[1F1F1F] pt-[14px] lg:text-left md:text-center text-left lg:px-0 px-6'>Shabuj Global Education helps you with Course & University<br></br> Selection, Interview and Test Preparation, Visa Application and<br></br> Admission and more- so you can join your dream university<br></br> with ease!</p>
                        <Link to={"/comingSoon"}>
                    ...
                    <div className='order-1 lg:order-2 lg:pt-0 md:pt-10'>
                        <img className='w-[148px] md:w-[298px] lg:w-[447px] mx-auto' src="./assets/students.png" alt="students" />
                    </div>
                </div>
            </div>
        </div>
            ...
            <div className="tab-content tab-2 color_div text-center lg:text-left">
                ...
                <div className='flex flex-col lg:flex-row justify-between gap-[28px]'>
                    <div className='order-2 lg:order-1'>
                        ...
                        <h2 className='poppins-semibold text-[20px] lg:text-[38px] text-[#081831] leading-[130%] lg:text-left md:text-center text-left lg:px-0 px-6'>Wow your students with<br></br> Shabuj Global Education's<br></br> trusted admission process</h2>
                        <p className='mulish-regular text-[12px] lg:text-[16px] text-[1F1F1F] pt-[14px] lg:text-left md:text-center text-left lg:px-0 px-6'>No more lack of trust and transparency- we treat your<br></br> business as our own. With SGE's 1500+ strong university<br></br> network, experienced counsellors, and dedicated customer<br></br> support, you can just focus on increasing your student reach-<br></br> and leave the processing part to us!</p>
                        <Link to={"/comingSoon"}><button className='bg-[#2563EB] hover:bg-[#126def] mulish-regular lg:text-[21px] text-[14px] text-white rounded-[32px] lg:px-[85px] px-10 lg:py-2 py-[3px] mt-6'>Explore More</button></Link>
                    </div>
