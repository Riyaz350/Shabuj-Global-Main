        ...
        <div className="lg:w-[1000px] md:w-[1000px] w-full  flex items-center lg:relative md:relative absolute lg:top-0 md:top-0 top-80 lg:overflow-hidden md:overflow-hidden overflow-visible lg:ml-auto md:ml-auto ml-10">
          ...
          >
            ...
            {sliders.map((slide, inx) => (
              ...
              >
                <img className="absolute w-fit md:w-1/6 lg:top-8 top-2 left-2 lg:left-8" src='https://i.ibb.co.com/tQnYRyP/Highlight.png' alt="" />
                <img
                  src={slide.img}
                  className="mx-auto mt-10 lg:mt-16 h-40  object-cover rounded-xl"
                  alt={slide.tags}
                />
