...
import Finland_FaqSVG from './Finland_FaqSVG';
...
const Finland_Faq = () => {
  const faq=[
    {
      question: "Which course is best for PR in Finland?",
      answer: "The cost of studying in Finland varies depending on factors such as the chosen university, course, and location. On average, international students can expect to pay between AUD 20,000 to AUD 45,000 per year for undergraduate programs and AUD 22,000 to AUD 50,000 per year for postgraduate programs."
    },
    {
      question: "How do I get PR in Finland?",
      answer: "There are different pathways to obtaining Permanent Residency in Finland. Some common routes include employer-sponsored visas, state/territory nomination programs, the Skilled Independent visa (subclass 189), the Skilled Nominated visa (subclass 190), and the Regional Skilled visa (subclass 491). Each pathway has its own specific criteria and requirements, which may include work experience, English language proficiency, skill assessments, and meeting the occupation list requirements."
    },
    {
    ...
    {
      question: "How much does an Finland study visa cost?",
      answer: "A student visa in Finland costs AUD 650 for international students. However, there are additional costs that one may have to pay. This includes costs for health checks, biometrics, police certificates, etc. If you are under the age of 18, your total Finland student visa fees will be AUD 650 + AUD 160."
    },
    {
    ...
    <div className="bg-white pt-7 md:pt-14 lg:pt-20">
      ...
      <div className="mx-auto md:max-w-screen-xl sm:px-6 lg:px-8">
        <div className="flex flex-col items-center gap-y-5 lg:flex-row lg:justify-between mx-auto">
          ...
          <div className="w-full lg:w-1/2 bg-[#e1b43d] h-[525px] rounded-[36px] ">
