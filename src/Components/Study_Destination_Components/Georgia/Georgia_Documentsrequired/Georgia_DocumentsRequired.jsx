import UAE_DocumentsSvg from "../../UAE/UAE_Documents/UAE_DocumentsSvg";
import Doc1 from "../../UK/SVG/Doc1";
import Doc2 from "../../UK/SVG/Doc2";



const Georgia_DocumentsRequired = () => {
  return (
    <>
...
export default Georgia_DocumentsRequired;
