...
import Faq_SVG_France from './SVG/Faq_SVG_France';


const Faq_France = () => {
  const faq=[
    {
      question: "How much can it cost to study in the France?",
      answer: "The cost of studying in the France can vary, but on average,it can range from £10,000 to £38,000 per year for international students."
    },
    {
      question: "How can I go to the France from Bangladesh to study?",
      answer: "To go to the France from Bangladesh to study, you need to apply for a student visa and meet the eligibility criteria set by the France government."
    },
    {
      question: "Do I need IELTS to study in the France?",
      answer: "Yes, generally, a valid IELTS score is required for studying in the France, although some universities may accept alternative English language proficiency tests."
    },
    {
      question: "What is the minimum qualification to study in the France?",
      answer: "The minimum qualification to study in the France is a completed secondary education or equivalent, such as A-levels, International Baccalaureate (IB), or equivalent qualifications."
    },
    {
      question: "What is the minimum GPA required to study in the France?",
      answer: "The minimum GPA required to study in the France can vary depending on the university and program, but a good academic record is generally expected."
    }
  ];
