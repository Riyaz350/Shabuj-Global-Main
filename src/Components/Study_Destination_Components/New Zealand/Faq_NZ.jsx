...
const Faq_NZ = () => {
  const faq=[
    {
      question: "How much can it cost to study in the New Zealand?",
      answer: "The cost of studying in the New Zealand can vary, but on average,it can range from £10,000 to £38,000 per year for international students."
    },
    {
      question: "How can I go to the New Zealand from Bangladesh to study?",
      answer: "To go to the New Zealand from Bangladesh to study, you need to apply for a student visa and meet the eligibility criteria set by the New Zealand government."
    },
    {
      question: "Do I need IELTS to study in the New Zealand?",
      answer: "Yes, generally, a valid IELTS score is required for studying in the New Zealand, although some universities may accept alternative English language proficiency tests."
    },
    {
      question: "What is the minimum qualification to study in the New Zealand?",
      answer: "The minimum qualification to study in the New Zealand is a completed secondary education or equivalent, such as A-levels, International Baccalaureate (IB), or equivalent qualifications."
    },
    {
      question: "What is the minimum GPA required to study in the New Zealand?",
      answer: "The minimum GPA required to study in the New Zealand can vary depending on the university and program, but a good academic record is generally expected."
    }
  ];
    ...
    <div className="bg-white pt-7 md:pt-14 lg:pt-20">
      ...
      <div className="mx-auto md:max-w-screen-xl sm:px-6 lg:px-8">
        <div className="flex flex-col items-center gap-y-5 lg:flex-row lg:justify-between mx-auto">
          ...
          <div className="w-full lg:w-1/2 bg-[#6aa84f] h-[525px] rounded-[36px] ">
