...
import './West_Indies_Counselor.css'
            ...
            <div className='max-w-[1154px] mx-auto'>
                <div className='flex justify-around lg:flex-row flex-col'>
                    <div className='lg:text-left text-center'>
                        <h1 className='lg:poppins-semibold poppins-bold lg:text-[56px] text-[28px] lg:leading-[72.8px] leading-[32px] -tracking-[0.01em] text-white pt-[51px] lg:pb-[69px] pb-[30px]'>Talk to Our Expert<br></br> West Indies Counselor</h1>
                    ...
                    <div className='lg:-mb-[90px] md:-mb-[62px] -mb-[10px] wICounselor mx-auto lg:-mt-[70px]'>
...
export default West_Indies_Counselor;