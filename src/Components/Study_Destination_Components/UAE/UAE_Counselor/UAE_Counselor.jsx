...
import './UAE_Counselor.css'
import CounsellorSVG from '../../Shared/CounsellorSvg/CounsellorSVG';

const UAE_Counselor = (props) => {
    return (
        <div className='bg-[#63099c]  mt-[90px] xl:pb-16 lg:pb-7 pb-4 px-4'>
            <div className='max-w-[1154px] mx-auto'>
                <div className='flex justify-around lg:flex-row flex-col'>
                    <div className='lg:text-left text-center'>
                        <h1 className='lg:poppins-semibold poppins-bold lg:text-[56px] text-[28px] lg:leading-[72.8px] leading-[32px] -tracking-[0.01em] text-white pt-[51px] lg:pb-[69px] pb-[30px]'>Talk to Our Expert<br></br> UAE Counselor</h1>
