...
const UAE_Requirement_Card_SmallScreen = () => {
    ...
    return (
        ...
        >
            ...
            <div>
              ...
              <div className={`${expandedCard == 1 ? "hidden" : "absolute"}  left-8 bottom-3 group-hover:hidden`}>
                <svg
        ...
        >
            ...
            <div>
              ...
              <div className={`${expandedCard == 2 ? "hidden" : "absolute"}  left-8 bottom-3 group-hover:hidden`}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="48"
                  height="48"
        ...
        >
            ...
            <div className={`${expandedCard == 3 ? "hidden" : "absolute"}  left-8 bottom-3 group-hover:hidden`}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="48"
                height="48"
        ...
        >
            ...
            <div className={`${expandedCard == 4 ? "hidden" : "absolute"}  left-8 bottom-3 group-hover:hidden`}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="48"
                height="48"
...
export default UAE_Requirement_Card_SmallScreen;