...
const UAE_Faq = () => {
  const faq=[
    {
      question: "Which course is best for PR in UAE?",
      answer: "The cost of studying in UAE varies depending on factors such as the chosen university, course, and location. On average, international students can expect to pay between AUD 20,000 to AUD 45,000 per year for undergraduate programs and AUD 22,000 to AUD 50,000 per year for postgraduate programs."
    },
    {
      question: "How do I get PR in UAE?",
    ...
    {
      question: "How much does an UAE study visa cost?",
      answer: "A student visa in UAE costs AUD 650 for international students. However, there are additional costs that one may have to pay. This includes costs for health checks, biometrics, police certificates, etc. If you are under the age of 18, your total Australia student visa fees will be AUD 650 + AUD 160."
    },
    {
      question: "How much does it cost to study in UAE?",
    ...
    <div className="bg-white pt-7 md:pt-14 lg:pt-20">
      ...
      <div className="mx-auto md:max-w-screen-xl sm:px-6 lg:px-8">
        <div className="flex flex-col items-center gap-y-5 lg:flex-row lg:justify-between mx-auto">
          ...
          <div className="w-full lg:w-1/2 bg-[#63099c] h-[525px] rounded-[36px] ">
