...
import Faq_SVG_Aus from './SVG/Faq_SVG_Aus';

const Faq_Aus = () => {
  const faq=[
    {
      question: "Which course is best for PR in Australia?",
      answer: "The cost of studying in Australia varies depending on factors such as the chosen university, course, and location. On average, international students can expect to pay between AUD 20,000 to AUD 45,000 per year for undergraduate programs and AUD 22,000 to AUD 50,000 per year for postgraduate programs."
    },
    {
      question: "How do I get PR in Australia?",
    ...
    {
      question: "How much does an Australian study visa cost?",
      answer: "A student visa in Australia costs AUD 650 for international students. However, there are additional costs that one may have to pay. This includes costs for health checks, biometrics, police certificates, etc. If you are under the age of 18, your total Australia student visa fees will be AUD 650 + AUD 160."
    },
    {
