        ...
        <div className="px-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 mb-[71px] ">
            ...
            {/* <div className="bg-[#FFFFFF] hover:bg-[#2563EB] card transition-all pastevents-shadow rounded-lg">
              ...
              <div className="p-5">
                <h2 className="poppins-medium text-[18px] text-[#000000] pt-[18px]">
                  Multi-Destination Education<br></br> Expo - Dhaka
                </h2>
                <div className="flex items-center gap-[10px] pt-[16px]">
                  <svg
                    width="18"
                ...
                <Link to={"/comingSoon"}>
                  <button className="poppins-semibold lg:text-[14px] text-[12px] text-[#4B4B4B] hover:text-[#2563EB] py-[7px] px-[96px] bg-[#FFFFFF] border border-[#E1E1E1]">
                    View Event Details
                  </button>
                </Link>
              </div>
          ...
          {/* <div className="flex gap-6 lg:flex-row flex-col">
            <div className="bg-[#FFFFFF] hover:bg-[#2563EB] card transition-all pastevents-shadow rounded-lg">
              ...
              <div className="p-5 mx-auto flex flex-col items-center">
                <h2 className="poppins-medium text-[18px] text-[#000000] pt-[18px]">
                  Multi-Destination Education<br></br> Expo - Dhaka
                </h2>
                <div className="flex items-center gap-[10px] pt-[16px]">
