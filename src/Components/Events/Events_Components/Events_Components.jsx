                            ...
                            <div className='lg:grid grid-cols-2 flex flex-col gap-5 justify-center my-10 '>
                                ...
                                <div className='flex flex-col justify-between col-span-1 rounded-2xl text-start space-y-2 shadow-2xl p-5 pt-0'>
                                    ...
                                    <ul className='text-[#F25025]'>
                                        ...
                                        <li className='flex items-center flex-col lg:flex-row justify-between '><span className='flex'><span className='flex items-center gap-2'><FaRegCalendarDays />22nd July, 2024 </span><span className='flex items-center gap-2'><GoDotFill />10:00 am - 05:00 pm</span></span><Link to={'/SingleEvent'}> <span className='rounded-2xl text-white bg-[#2563EB] p-2 font-light text-xs px-2 cursor-pointer' >Register Now</span></Link></li>
                                    </ul>
                                </div>
