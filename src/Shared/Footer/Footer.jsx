                ...
                <div className='bg-[#081831] px-6 relative'>
                            ...
                            <div className='max-w-[1152px] mx-auto pt-[23px] pb-[23px]' ref={accordion}>
                                <div className='flex lg:flex-row flex-col lg:mx-4 md:mx-12 mx-8'>
                                    ...
                                    <div className='lg:w-[25%] w-full pb-8'>
                                        ...
                                        <div className="collapse collapse-arrow">
                                            <input type="checkbox" name="my-accordion-2" onClick={(e) => { handleClick(e) }} />
                                            <div className="collapse-title text-base poppins-medium text-[#CACACA]">Chattogram</div>
                                            <div className="collapse-content text-sm text-[#CACACA]">
                                        ...
                                        <div className="collapse collapse-arrow">
                                            <input type="checkbox" name="my-accordion-2" onClick={(e) => { handleClick(e) }} />
                                            <div className="collapse-title text-base poppins-medium text-[#CACACA]">Sylhet</div>
                                            <div className="collapse-content text-sm text-[#CACACA]">
                                    ...
                                    <div className='lg:w-[16%] w-full pb-8'>
                                        ...
                                        <div className="collapse collapse-arrow">
                                            <input type="checkbox" name="my-accordion-2" onClick={(e) => { handleClick(e) }} />
                                            <div className="collapse-title text-base poppins-medium text-[#CACACA]">Kannur</div>
                                            <div className="collapse-content text-sm text-[#CACACA]">
                                                <p>R.I. Tower(level 3),23/A MM Ali Road,Golpahar moor,Chattogram.</p>
                                            </div>
                                        </div>
                                    ...
                                    <div className='lg:w-[16%] w-full pb-8'>
                                        ...
                                        <div className="collapse collapse-arrow">
                                            <input type="checkbox" name="my-accordion-2" onClick={(e) => { handleClick(e) }} />
                                            <div className="collapse-title text-base poppins-medium text-[#CACACA]">Lagos</div>
                                            <div className="collapse-content text-sm text-[#CACACA]">
                                    ...
                                    <div className='lg:w-[18%] w-full pb-8'>
                                        ...
                                        <div className="collapse collapse-arrow">
                                            <input type="checkbox" name="my-accordion-2" onClick={(e) => { handleClick(e) }} />
                                            <div className="collapse-title text-base poppins-medium text-[#CACACA]">UAE</div>
                                            <div className="collapse-content text-sm text-[#CACACA]">
                                        ...
                                        <div className="collapse collapse-arrow">
                                            <input type="checkbox" name="my-accordion-2" onClick={(e) => { handleClick(e) }} />
                                            <div className="collapse-title text-base poppins-medium text-[#CACACA]">Qatar</div>
                                            <div className="collapse-content text-sm text-[#CACACA]">
                    ...
                    <div className='footer-4 max-w-[1154px] relative z-10 mx-auto pb-6 flex flex-col lg:flex-row justify-between items-center border-t border-white'>
                        ...
                        <div className='flex lg:gap-[18px] flex-col items-center lg:flex-row text-center'>
                            ...
                            <a href='/comingSoon'><p className='mulish-regular text-[14px] text-[#CACACA]'>Terms & Conditions</p></a>
                            <a href='/Privacy'><p className='mulish-regular text-[14px] text-[#CACACA]'>Privacy Policy</p></a>
                        </div>
                    </div>
